 ...
 * writing integration tests for repositories. When we want to write integration
 * tests for a repository, we have to annotate our integration class with this annotation.
