 ...
 * container that is started before a test method is run and destroyed
 * after a test method has been run.
 */
public class RuleGenericContainerTest {

    @Rule
    public GenericContainer webServer = new GenericContainer("alpine:3.2")
            .withExposedPorts(80)
            .withCommand("/bin/sh",
                    "-c",
