...
public final class TestDoubles {
    ...
    /**
     * Creates a mock that throws a {@code RuntimeException} if the system under test
     * invokes a method whose answer has not been configured.
     *
     * @param mockClass     The class represents the created mock.
     * @param <T>           The type of the created mock.
     * @return              The created mock.
     */
    public static <T> T strictMock(Class<T> mockClass) {
        return mock(mockClass, new Answer() {
            @Override
            public Object answer(InvocationOnMock invocation) throws Throwable {
                throw new RuntimeException("The system under test invoked an unexpected method of a mock");
            }
        });
    }
}
