...
public class Task {
    ...
    public static class Builder {
        ...
        private void checkModifier(Task task) {
            Modifier modifier = task.getModifier();
            if (modifier == null) {
                throw new NullPointerException("You cannot create a new task without specifying the modifier of the task");
            }
        }
