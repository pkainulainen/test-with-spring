...
public class Task {
    ...
    public void closeWithResolutionDone(Long closerId) {
        close(closerId, TaskResolution.DONE);
    }

    public void closeWithResolutionDuplicate(Long closerId) {
        close(closerId, TaskResolution.DUPLICATE);
    }

    public void closeWithResolutionWontDo(Long closerId) {
        close(closerId, TaskResolution.WONT_DO);
    }

    private void close(Long closerId, TaskResolution resolution) {
